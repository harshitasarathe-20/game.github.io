...
function increaseValue1() {
    ...
    var value = parseInt(document.getElementById('number').value, 10); // so2
    var value1 = parseInt(document.getElementById('num').value, 10); // o2
    var value2 = parseInt(document.getElementById('no').value, 10); // so3
    ...
    if (value == 1) {
        ...
        var k = document.getElementById('hyd333').style.visibility = "visible";
    }
    else {
        rotateL();
...
function increaseValue2() {
    ...
    var value = parseInt(document.getElementById('num').value, 10);//o2
    var value1 = parseInt(document.getElementById('number').value, 10); // so2
    var value2 = parseInt(document.getElementById('no').value, 10);//so3
...
function increaseValue3() {
    var value = parseInt(document.getElementById('no').value, 10); //so3
    var value1 = parseInt(document.getElementById('number').value, 10); // so2
    var value2 = parseInt(document.getElementById('num').value, 10); // o2
