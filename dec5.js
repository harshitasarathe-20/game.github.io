...
function increaseValue2() {
    ...
    var value = parseInt(document.getElementById('num').value, 10);//h2co3
    var value2 = parseInt(document.getElementById('no').value, 10);//co2
    var value3 = parseInt(document.getElementById('numb').value, 10); //h2o
    ...
    if (value == 1) {
        ...
        var k = document.getElementById('b11111').style.visibility = "visible";
    }
    else if (value == 2) {
        rotateL();
        ...
        var f = document.getElementById('b22222').style.visibility = "visible";
    }
    else if (value == 3) {
        rotateL();
        ...
        var s = document.getElementById('b33333').style.visibility = "visible";
    }
    else {
        rotateL();
...
function decreaseValue2() {
    ...
    if (value == 2) {
        ...
        var k = document.getElementById('b33333').style.visibility = "hidden";
        ...
        var f = document.getElementById('b22222').style.visibility = "hidden";
    }
    else if (value == 0) {
        rotateLeft();
        ...
        var s = document.getElementById('b11111').style.visibility = "hidden";
    }
    else {
        rotateLeft();
    }
...
function increaseValue3() {
    var value = parseInt(document.getElementById('no').value, 10); //h2co3
   
    var value2 = parseInt(document.getElementById('num').value, 10); //co2
    var value3 = parseInt(document.getElementById('numb').value, 10); //h2o
...
function increaseValue4() {
    // console.log("222222222222222222222222222222222222222")
    var value3 = parseInt(document.getElementById('num').value, 10);//h2co3
   
    var value2 = parseInt(document.getElementById('no').value, 10);//co2
    var value = parseInt(document.getElementById('numb').value, 10); //h2o
    ...
    if (value == 1) {
        ...
        var a = document.getElementById('d111').style.visibility = "visible";
    }
    else if (value == 2) {
        rotate();
        ...
        var g = document.getElementById('d222').style.visibility = "visible";
    }
    else if (value == 3) {
        rotate();
        ...
        var k = document.getElementById('d333').style.visibility = "visible";
    }
    else {
        rotate();
        var x = document.getElementById('o4').style.visibility = "visible";
...
function decreaseValue4() {
    ...
    if (value == 2) {
        ...
        var k = document.getElementById('d333').style.visibility = "hidden";
        ...
        var l = document.getElementById('d222').style.visibility = "hidden";
    }
    else if (value == 0) {
        rotateR();
        ...
        var k = document.getElementById('d111').style.visibility = "hidden";
    }
    else {
        rotateR();
    }
...
function submit() {
    var value = parseInt(document.getElementById('no').value, 10); // co2
   
    var value2 = parseInt(document.getElementById('num').value, 10); // h2co3
    var value3 = parseInt(document.getElementById('numb').value, 10);//h2o
