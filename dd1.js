...
function increaseValue1() {
    ...
    var value = parseInt(document.getElementById('number').value, 10); // BaCl2
    var value1 = parseInt(document.getElementById('num').value, 10); // H2SO4
    ...
    if (value == 1) {
        ...
        var o = document.getElementById('a111').style.visibility = "visible";
    }
    else if (value == 2) {
        rotateL();
        ...
        var o = document.getElementById('a222').style.visibility = "visible";
    }
    else if (value == 3) {
        rotateL();
        var x = document.getElementById('h3').style.visibility = "visible";
        var y = document.getElementById('x1').style.visibility = "visible";
        var z = document.getElementById('x11').style.visibility = "visible";
        var o = document.getElementById('x111').style.visibility = "visible";
    }
    else {
        rotateL();
        var x = document.getElementById('h4').style.display = "inline";
    }
    if (value == 1 && value1 == 1 && value2 == 1 && value3 == 2) {
...
function decreaseValue1() {
    ...
    if (value == 2) {
        ...
        var z = document.getElementById('x1').style.visibility = "hidden";
        var y = document.getElementById('x11').style.visibility = "hidden";
        var o = document.getElementById('x111').style.visibility = "hidden";
...
function increaseValue2() {
    ...
    if (value == 1) {
        ...
        var y = document.getElementById('y1').style.visibility = "visible";
        var z = document.getElementById('y11').style.visibility = "visible";
...
function decreaseValue2() {
    ...
    if (value == 2) {
        ...
        var y = document.getElementById('y1').style.visibility = "hidden";
        var z = document.getElementById('y11').style.visibility = "hidden";
        var o = document.getElementById('y111').style.visibility = "hidden";
...
function increaseValue3() {
    var value = parseInt(document.getElementById('no').value, 10); //BaSO4
    var value1 = parseInt(document.getElementById('number').value, 10); // BaCl2
    var value2 = parseInt(document.getElementById('num').value, 10); // H2SO4
    var value3 = parseInt(document.getElementById('numb').value, 10); //HCl
...
function increaseValue4() {
    ...
    var value2 = parseInt(document.getElementById('num').value, 10);//H2SO4
    var value1 = parseInt(document.getElementById('number').value, 10); // BaCl2
    var value3 = parseInt(document.getElementById('no').value, 10);//BaSO4
    var value = parseInt(document.getElementById('numb').value, 10); //HCl
