...
function increaseValue1() {
    ...
    var value = parseInt(document.getElementById('number').value, 10); // naoh
    var value1 = parseInt(document.getElementById('num').value, 10); // h2so4
    var value2 = parseInt(document.getElementById('no').value, 10); // na2so4
    ...
    if (value == 1) {
        ...
        var m = document.getElementById('a111').style.visibility = "visible";
        ...
        var m = document.getElementById('a222').style.visibility = "visible";
        ...
        var m = document.getElementById('a333').style.visibility = "visible";
    ...
    if (value == 2 && value1 == 1 && value2 == 1 && value3 == 2) {
...
function decreaseValue1() {
    ...
    if (value == 2) {
        ...
        var y = document.getElementById('a333').style.visibility = "hidden";
...
function increaseValue2() {
    ...
    var value1 = parseInt(document.getElementById('number').value, 10); //naoh
    var value2 = parseInt(document.getElementById('no').value, 10);//na2so4
    var value3 = parseInt(document.getElementById('numb').value, 10); //H2o
...
function decreaseValue2() {
    ...
    if (value == 2) {
        ...
        var y = document.getElementById('b333').style.visibility = "hidden";
...
function increaseValue3() {
    var value = parseInt(document.getElementById('no').value, 10); //na2so4
    var value1 = parseInt(document.getElementById('number').value, 10); //naoh
...
function increaseValue4() {
    ...
    var value2 = parseInt(document.getElementById('num').value, 10);//h2so4
    var value1 = parseInt(document.getElementById('number').value, 10); //naoh
    var value3 = parseInt(document.getElementById('no').value, 10);//na2so4
