...
function increaseValue1() {
    ...
    var value = parseInt(document.getElementById('number').value, 10); // kno3
    var value1 = parseInt(document.getElementById('num').value, 10); // alcl3
    var value2 = parseInt(document.getElementById('no').value, 10); // alno3
    var value3 = parseInt(document.getElementById('numb').value, 10); //kcl
    ...
    if (value == 3 && value1 == 1 && value2 == 1 && value3 == 3) {
...
function increaseValue2() {
    ...
    var value1 = parseInt(document.getElementById('number').value, 10); //kno3
    var value2 = parseInt(document.getElementById('no').value, 10);//alno3
    var value3 = parseInt(document.getElementById('numb').value, 10); //kcl
    ...
    if (value == 1) {
        ...
        var f = document.getElementById('b1111').style.visibility = "visible";
    }
    else if (value == 2) {
        rotateL();
        ...
        var f = document.getElementById('b2222').style.visibility = "visible";
    }
    else if (value == 3) {
        rotateL();
        ...
        var f = document.getElementById('b3333').style.visibility = "visible";
    }
    else {
        rotateL();
        var x = document.getElementById('o4').style.visibility = "visible";
    }
    if (value == 1 && value1 == 3 && value2 == 1 && value3 == 3) {
        console.log("xxxxxxxxxxxxxxxxxxxx", value, value1, value2)
        document.getElementById('num').value = value
        rotateFinal()
        return
...
function decreaseValue2() {
    ...
    if (value == 2) {
        ...
        var m = document.getElementById('b333').style.visibility = "hidden";
...
function increaseValue3() {
    var value = parseInt(document.getElementById('no').value, 10); //alno3
    var value1 = parseInt(document.getElementById('number').value, 10); //kno3
    ...
    if (value == 1) {
        ...
        var n = document.getElementById('c1111').style.visibility = "visible";
        ...
        var n = document.getElementById('c2222').style.visibility = "visible";
        ...
        var n = document.getElementById('c3333').style.visibility = "visible";
...
function decreaseValue3() {
    ...
    if (value == 2) {
        ...
        var n = document.getElementById('c3333').style.visibility = "hidden";
        ...
        var n = document.getElementById('c2222').style.visibility = "hidden";
        ...
        var n = document.getElementById('c1111').style.visibility = "hidden";
...
function increaseValue4() {
    ...
    var value2 = parseInt(document.getElementById('num').value, 10);//alcl3
    var value1 = parseInt(document.getElementById('number').value, 10); //kno3
    var value3 = parseInt(document.getElementById('no').value, 10);//alno3
    var value = parseInt(document.getElementById('numb').value, 10); //kcl
    ...
    if (value == 3  && value1 == 3 && value2 == 1 && value3 == 1) {
        console.log("xxxxxxxxxxxxxxxxxxxx", value, value1, value2)
        document.getElementById('numb').value = value
        rotateFinal();
        return
