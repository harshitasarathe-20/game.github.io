...
function increaseValue1() {
    ...
    var value = parseInt(document.getElementById('number').value, 10); // n2
    var value1 = parseInt(document.getElementById('num').value, 10); // h2
    var value2 = parseInt(document.getElementById('no').value, 10); // nh3
...
function increaseValue2() {
    ...
    var value = parseInt(document.getElementById('num').value, 10);//h2
    var value1 = parseInt(document.getElementById('number').value, 10); // n2
    var value2 = parseInt(document.getElementById('no').value, 10);//nh3
...
function increaseValue3() {
    var value = parseInt(document.getElementById('no').value, 10); //nh3
    var value1 = parseInt(document.getElementById('number').value, 10); // n2
    var value2 = parseInt(document.getElementById('num').value, 10); // h2
