...
function increaseValue1() {
    ...
    var value = parseInt(document.getElementById('number').value, 10); // k
    var value1 = parseInt(document.getElementById('num').value, 10); // mgcl2
    var value2 = parseInt(document.getElementById('no').value, 10); // kcl
    var value3 = parseInt(document.getElementById('numb').value, 10); //mg
    ...
    if (value == 1) {
        ...
        var y = document.getElementById('hyd11').style.visibility = "visible";/*
        ...
        var o = document.getElementById('hyd111').style.visibility = "visible";/*
    ...
    if (value == 2 && value1 == 1 && value2 == 2 && value3 == 1) {
...
function decreaseValue1() {
    ...
    if (value == 2) {
        ...
        var y = document.getElementById('hyd111').style.visibility = "hidden";/*
...
function increaseValue2() {
    ...
    var value = parseInt(document.getElementById('num').value, 10);//mgcl2
    var value1 = parseInt(document.getElementById('number').value, 10); // k
    var value2 = parseInt(document.getElementById('no').value, 10);//kcl
    var value3 = parseInt(document.getElementById('numb').value, 10); //mg
    ...
    if (value == 1 && value1 == 2 && value2 == 2 && value3 == 1) {
        console.log("xxxxxxxxxxxxxxxxxxxx", value, value1, value2)
        document.getElementById('num').value = value
        rotateFinal()
        return
...
function increaseValue3() {
    var value = parseInt(document.getElementById('no').value, 10); //kcl
    var value1 = parseInt(document.getElementById('number').value, 10); // k
    var value2 = parseInt(document.getElementById('num').value, 10); // mgcl2
    var value3 = parseInt(document.getElementById('numb').value, 10); //mg
    ...
    if (value == 2 && value1 == 2 && value2 == 1 && value3 == 1) {
        console.log("xxxxxxxxxxxxxxxxxxxx", value, value1, value2)
        document.getElementById('no').value = value
        rotateFinal()
        return
...
function increaseValue4() {
    ...
    var value2 = parseInt(document.getElementById('num').value, 10);//mgcl2
    var value1 = parseInt(document.getElementById('number').value, 10); // k
    var value3 = parseInt(document.getElementById('no').value, 10);//kcl
    var value = parseInt(document.getElementById('numb').value, 10); //mg
    ...
    if (value == 1 && value1 == 2 && value2 == 1 && value3 == 2) {
        console.log("xxxxxxxxxxxxxxxxxxxx", value, value1, value2)
        document.getElementById('numb').value = value
        rotateFinal()
        return
