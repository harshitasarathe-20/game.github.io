...
function increaseValue1() {
    ...
    var value = parseInt(document.getElementById('number').value, 10); // mg
    var value1 = parseInt(document.getElementById('num').value, 10); // alcl3
    var value2 = parseInt(document.getElementById('no').value, 10); // mgcl2
    var value3 = parseInt(document.getElementById('numb').value, 10); //al
    ...
    if (value == 1) {
        ...
        var w = document.getElementById('hyd111').style.visibility = "visible";*/
        ...
        var w = document.getElementById('hyd222').style.visibility = "visible";*/
        ...
        var w = document.getElementById('hyd333').style.visibility = "visible";*/
    }
    else {
        rotateL();
        var x = document.getElementById('h4').style.display = "inline";
    }
    if (value == 3 && value1 == 2 && value2 == 3 && value3 == 2) {
...
function decreaseValue1() {
    ...
    if (value == 2) {
       ...
       /* var y = document.getElementById('hyd33').style.visibility = "hidden";
        ...
        var m = document.getElementById('hyd3').style.visibility = "hidden";
...
function increaseValue2() {
    ...
    var value = parseInt(document.getElementById('num').value, 10);//alcl3
    var value1 = parseInt(document.getElementById('number').value, 10); //mg
    var value2 = parseInt(document.getElementById('no').value, 10);//mgcl2
    var value3 = parseInt(document.getElementById('numb').value, 10); //al
    ...
    if (value == 1) {
        ...
        var l = document.getElementById('oxy11').style.visibility = "visible";
        var w = document.getElementById('oxy111').style.visibility = "visible";
        var n = document.getElementById('oxy1111').style.visibility = "visible";
        ...
        var l = document.getElementById('oxy22').style.visibility = "visible";
        var w = document.getElementById('oxy222').style.visibility = "visible";
        var n = document.getElementById('oxy2222').style.visibility = "visible";
        ...
        var l = document.getElementById('oxy33').style.visibility = "visible";
        var w = document.getElementById('oxy333').style.visibility = "visible";
        var n = document.getElementById('oxy3333').style.visibility = "visible";
    ...
    if (value == 2 && value1 == 3 && value2 == 3 && value3 == 2) {
        console.log("xxxxxxxxxxxxxxxxxxxx", value, value1, value2)
        document.getElementById('num').value = value
        rotateFinal()
        return
...
function decreaseValue2() {
    ...
    if (value == 2) {
        ...
        var y = document.getElementById('oxy1111').style.visibility = "hidden";
        var z = document.getElementById('oxy111').style.visibility = "hidden";
        var l = document.getElementById('oxy11').style.visibility = "hidden";
        var w = document.getElementById('oxy1').style.visibility = "hidden";
        ...
        var z = document.getElementById('oxy2222').style.visibility = "hidden";
        var y = document.getElementById('oxy222').style.visibility = "hidden";
        var l = document.getElementById('oxy22').style.visibility = "hidden";
        var w = document.getElementById('oxy2').style.visibility = "hidden";
    }
    else if (value == 0) {
        rotateLeft();
        var x = document.getElementById('o1').style.visibility = "hidden";
        var z = document.getElementById('oxy3333').style.visibility = "hidden";
        var y = document.getElementById('oxy333').style.visibility = "hidden";
        var l = document.getElementById('oxy33').style.visibility = "hidden";
        var w = document.getElementById('oxy3').style.visibility = "hidden";
    }
    else {
        rotateLeft();
    }
...
function increaseValue3() {
    var value = parseInt(document.getElementById('no').value, 10); //mgcl2
    var value1 = parseInt(document.getElementById('number').value, 10); //mg
    var value2 = parseInt(document.getElementById('num').value, 10); // alcl3
    var value3 = parseInt(document.getElementById('numb').value, 10); //al
    ...
    if (value == 3 && value1 == 3 && value2 == 2 && value3 == 2) {
        console.log("xxxxxxxxxxxxxxxxxxxx", value, value1, value2)
        document.getElementById('no').value = value
        rotateFinal()
        return
...
function increaseValue4() {
    ...
    var value2 = parseInt(document.getElementById('num').value, 10);//alcl3
    var value1 = parseInt(document.getElementById('number').value, 10); // mg
    var value3 = parseInt(document.getElementById('no').value, 10);//mgcl2
    var value = parseInt(document.getElementById('numb').value, 10); //al
    ...
    if (value == 2 && value1 == 3 && value2 == 2 && value3 == 3) {
        console.log("xxxxxxxxxxxxxxxxxxxx", value, value1, value2)
        document.getElementById('numb').value = value
        rotateFinal()
        return
