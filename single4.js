...
function increaseValue1() {
    ...
    var value = parseInt(document.getElementById('number').value, 10); // hbr
    var value1 = parseInt(document.getElementById('num').value, 10); // cl2
    var value2 = parseInt(document.getElementById('no').value, 10); // hcl
    var value3 = parseInt(document.getElementById('numb').value, 10); //br2
...
function increaseValue2() {
    ...
    var value = parseInt(document.getElementById('num').value, 10);//cl2
    var value1 = parseInt(document.getElementById('number').value, 10); // hbr
    var value2 = parseInt(document.getElementById('no').value, 10);//hcl
    var value3 = parseInt(document.getElementById('numb').value, 10); //br2
...
function increaseValue3() {
    var value = parseInt(document.getElementById('no').value, 10); //hcl
    var value1 = parseInt(document.getElementById('number').value, 10); // hbr
    var value2 = parseInt(document.getElementById('num').value, 10); // cl2
    var value3 = parseInt(document.getElementById('numb').value, 10); //br2
...
function increaseValue4() {
    ...
    var value2 = parseInt(document.getElementById('num').value, 10);//cl2
    var value1 = parseInt(document.getElementById('number').value, 10); // hbr
    var value3 = parseInt(document.getElementById('no').value, 10);//hcl
    var value = parseInt(document.getElementById('numb').value, 10); //br2
