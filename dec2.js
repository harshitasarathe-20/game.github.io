...
function increaseValue2() {
    ...
    var value = parseInt(document.getElementById('num').value, 10);//naoh
    var value2 = parseInt(document.getElementById('no').value, 10);//na2o
...
function decreaseValue2() {
    ...
    var value2 = parseInt(document.getElementById('no').value, 10); //na2o
    var value3 = parseInt(document.getElementById('numb').value, 10); //h20=o
...
function increaseValue3() {
    var value = parseInt(document.getElementById('no').value, 10); //na2o
   
    var value2 = parseInt(document.getElementById('num').value, 10); // naoh
    var value3 = parseInt(document.getElementById('numb').value, 10); //h2o
...
function increaseValue4() {
    // console.log("222222222222222222222222222222222222222")
    var value3 = parseInt(document.getElementById('num').value, 10);//naoh
    ...
    if (value == 1) {
        ...
        var n = document.getElementById('d111').style.visibility = "visible";
    }
    else if (value == 2) {
        rotate();
        ...
        var n = document.getElementById('d222').style.visibility = "visible";
    }
    else if (value == 3) {
        rotate();
        ...
        var n = document.getElementById('d333').style.visibility = "visible";
    }
    else {
        rotate();
        var x = document.getElementById('o4').style.visibility = "visible";
...
function decreaseValue4() {
    ...
    var value2 = parseInt(document.getElementById('no').value, 10); //na2o
    var value = parseInt(document.getElementById('numb').value, 10); //o2
    ...
    if (value == 2) {
        ...
        var l = document.getElementById('d333').style.visibility = "hidden";
        ...
        var l = document.getElementById('d111').style.visibility = "hidden";
    }
    else {
        rotateR();
    }
...
function submit() {
    ...
    var value2 = parseInt(document.getElementById('num').value, 10); // naoh
    var value3 = parseInt(document.getElementById('numb').value, 10);//na2o
