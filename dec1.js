...
function increaseValue2() {
    ...
    var value = parseInt(document.getElementById('num').value, 10);//H2o2
...
function increaseValue3() {
    ...
    var value2 = parseInt(document.getElementById('num').value, 10); // h2o2
    var value3 = parseInt(document.getElementById('numb').value, 10); //o2
...
function decreaseValue3() {
    ...
    var value = parseInt(document.getElementById('no').value, 10); // h20
...
function increaseValue4() {
    // console.log("222222222222222222222222222222222222222")
    var value3 = parseInt(document.getElementById('num').value, 10);//H2o2
...
function decreaseValue4() {
    ...
    var value2 = parseInt(document.getElementById('no').value, 10); //h20
    var value = parseInt(document.getElementById('numb').value, 10); //o2
