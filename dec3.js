...
function increaseValue2() {
    ...
    var value = parseInt(document.getElementById('num').value, 10);//kclo3
    var value2 = parseInt(document.getElementById('no').value, 10);//kcl
    var value3 = parseInt(document.getElementById('numb').value, 10); //o2
    ...
    if (value == 1) {
        ...
        var z = document.getElementById('b11111').style.visibility = "visible";
    }
    else if (value == 2) {
        rotateL();
        ...
        var m = document.getElementById('b22222').style.visibility = "visible";
    }
    else if (value == 3) {
        rotateL();
        ...
        var m = document.getElementById('b33333').style.visibility = "visible";
    }
    else {
        rotateL();
        var x = document.getElementById('o4').style.visibility = "visible";
    }
    if (value == 2 && value2 == 2 && value3 == 3) {
...
function decreaseValue2() {
    ...
    if (value == 2) {
        ...
        var k = document.getElementById('b22222').style.visibility = "hidden";
    }
    else if (value == 0) {
        rotateLeft();
        ...
        var k = document.getElementById('b11111').style.visibility = "hidden";
    }
    else {
        rotateLeft();
    }
...
function increaseValue3() {
    ...
    var value2 = parseInt(document.getElementById('num').value, 10); // kclo3
    var value3 = parseInt(document.getElementById('numb').value, 10); //o2
...
function increaseValue4() {
    // console.log("222222222222222222222222222222222222222")
    var value3 = parseInt(document.getElementById('num').value, 10);//kclo3
