...
function increaseValue1() {
    ...
    var value = parseInt(document.getElementById('number').value, 10); // na
    var value1 = parseInt(document.getElementById('num').value, 10); // h2o
    var value2 = parseInt(document.getElementById('no').value, 10); // naoh
    ...
    if (value == 2 && value1 == 2 && value2 == 2 && value3 == 1) {
...
function increaseValue2() {
    ...
    var value = parseInt(document.getElementById('num').value, 10);//h2o
    var value1 = parseInt(document.getElementById('number').value, 10); // na
    var value2 = parseInt(document.getElementById('no').value, 10);//naoh
    var value3 = parseInt(document.getElementById('numb').value, 10); //h2
...
function increaseValue3() {
    var value = parseInt(document.getElementById('no').value, 10); //naoh
    var value1 = parseInt(document.getElementById('number').value, 10); // na
    var value2 = parseInt(document.getElementById('num').value, 10); // h2o
    var value3 = parseInt(document.getElementById('numb').value, 10); //h2
...
function increaseValue4() {
    ...
    var value2 = parseInt(document.getElementById('num').value, 10);//h2o
    var value1 = parseInt(document.getElementById('number').value, 10); // na
    var value3 = parseInt(document.getElementById('no').value, 10);//naoh
    ...
    if (value == 1 && value1 == 2 && value2 == 2 && value3 == 2) {
        console.log("xxxxxxxxxxxxxxxxxxxx", value, value1, value2)
        document.getElementById('numb').value = value
        rotateFinal()
        return
